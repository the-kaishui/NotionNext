...
const BLOG = {
  ...
  CONTACT_EMAIL: 'www.drholmeser@foxmail.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: 'https://twitter.com/thehot_water?s=09', // 你的twitter个人主页
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Kaishui’ BLOG', // 站点标题 ，被notion中的页面标题覆盖
